...
export default class Dash extends React.PureComponent {
	...
	getDeviceList() {
		this.serverRequest = $.get('http://[fd14:ac28:a278:1:edfb:5a6b:42f4:8436]:8000/api/devices/?format=json', function(result) {
			this.setState({
				device_list: result,
			});
		}.bind(this))
	...
	handleData(data) {
		...
		if (devices != '') {
			this.serverRequest = $.get('http://[fd14:ac28:a278:1:edfb:5a6b:42f4:8436]:8000/api/devices-details/'+devices+'/?format=json', function(data) {
				this.setState({
